...
function SettingsMenu({sound, setSound, showApiExamples, setShowGoogleSettings, setShowApiExamples, setGoogleSpread, googleLink, googleSpread}) {
    ...
    const Button = ({ onClick, children, className = '' }) => (
        <button
            className={`buttonStyle text-4xl sm:text-4xl font-bold ${className}`}
            onClick={onClick}
        >
            {children}
        </button>
...
function GoogleSettings({ googleLink, setGoogleLink, setLoading }) {

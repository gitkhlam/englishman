...
export default function Preloader({ onComplete, loadingData }) {
    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            ...
            if (index > fullText.length) {
                ...
                !loadingData && (index > fullText.length) && onComplete();
                index = 0;
            }
        }, 100);
    ...
    return (
        <div className="fixed inset-0 z-999 bg-[var(--light)] text-[var(--dark)] dark:bg-[var(--dark)] dark:text-[var(--light)] flex flex-col items-center justify-center p-10">
